...
public class StartActivity extends Activity {
    ...
    private static final float ratioTextScreenWidthDPTitles=((float)40/360);
    private static final float ratioTextScreenWidthDPTexts=((float)23/360);
    private static final float ratioTextScreenWidthDPRadioButtons=((float)30/360);
    private static final float ratioTextScreenWidthDPButtons=((float)30/360);
    private static final float ratioTextScreenWidthDPInputTexts=((float)50/360);
    ...
    public void adaptTextSize()
    {
        ...
        float deviceWidthDP = convertPixelsToDp(metrics.widthPixels,context);
        int titlesSize=(int)(ratioTextScreenWidthDPTitles*deviceWidthDP);
        int textSize=(int)(ratioTextScreenWidthDPTexts*deviceWidthDP);
        int radioButtonSize=(int)(ratioTextScreenWidthDPRadioButtons*deviceWidthDP);
        int buttonSize=(int)(ratioTextScreenWidthDPButtons*deviceWidthDP);
        int inputTextSize=(int)(ratioTextScreenWidthDPInputTexts*deviceWidthDP);
