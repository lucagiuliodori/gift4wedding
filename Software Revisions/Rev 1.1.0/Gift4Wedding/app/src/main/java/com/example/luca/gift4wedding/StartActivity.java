...
public class StartActivity extends Activity {
    ...
    private static final float ratioTextScreenWidthTitles=((float)1/30);
    private static final float ratioTextScreenWidthTexts=((float)1/50);
    private static final float ratioTextScreenWidthRadioButtons=((float)1/40);
    private static final float ratioTextScreenWidthButtons=((float)1/40);
    private static final float ratioTextScreenWidthInputTexts=((float)1/24);
